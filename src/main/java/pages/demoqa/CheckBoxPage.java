...
// наследуемся из класса BasePage (все методы которые там, теперь тут) и наследуем драйвер
   public class CheckBoxPage extends BasePage {

    public CheckBoxPage(WebDriver driver) {
        super(driver);
    }
    private static final String URL_CHECKBOX_PAGE = "https://demoqa.com/checkbox";
/** *
 * Локатор до Input элемента чекбокса*/
    private static final String CHECK_BOX_INPUT_XPATH = "//input[@type='checkbox']" +
            "[following-sibling::span[text()='%s']]";
    /** *
    ...
    private static final String BUTTON_TOGGLE = CHECK_BOX_INPUT_XPATH +
            "/../preceding-sibling::button[@title='Toggle']";
    /** *
     * Локатор для проверки, что строки свернуты/развернуты*/
    private static final String LIST_CHECKBOX_XPATH = CHECK_BOX_INPUT_XPATH +
            "/ancestor::li[contains(@class,'%s')]";

    /**
     * Открыть страницу с элементами "Check Box"
     */
    public void openCheckBoxPage() {
        openUrl(URL_CHECKBOX_PAGE);
    }
    /**
